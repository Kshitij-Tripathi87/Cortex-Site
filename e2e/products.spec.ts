...
const PRODUCTS = [
  { slug: "workflo", name: "Workflo", cat: "Execution Assurance", second: "Sandbox" },
  { slug: "nexus", name: "Nexus", cat: "Operations Intelligence", second: "World State" },
  { slug: "astra", name: "ASTRA", cat: "Mission Engineering", second: "Requirements" },
];
...
for (const product of PRODUCTS) {
  test(`${product.slug} brief is complete`, async ({ page }) => {
    ...
    await expect(page.locator(".cx-secnum", { hasText: "Performance / evidence" })).toBeVisible();
