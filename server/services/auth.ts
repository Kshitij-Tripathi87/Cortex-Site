...
/**
 * Authenticate an admin with Supabase Auth credentials and verify the account
 * is linked to an enabled row in public.admin_users.
 */
...
/**
 * Validate a Supabase access token for callers that need bearer authentication.
 * The current admin UI uses the opaque session cookie flow instead.
 */
